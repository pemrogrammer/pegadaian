...
const Contract = {
  ...
  state: {
    ...
    tab_active: "customer", // item, customer, confirm
  },
  mutations: {
    ...
    // start customer
    INSERT_FORM_CUSTOMER_NAME(state, payload) {
      state.form.customer.name = payload.name;
    },
    INSERT_FORM_CUSTOMER_DATE_BIRTH(state, payload) {
      state.form.customer.date_birth = payload.date_birth;
    },
    INSERT_FORM_CUSTOMER_GENDER(state, payload) {
      state.form.customer_gender = payload.gender;
    },
    INSERT_FORM_CUSTOMER_ADDRESS(state, payload) {
      state.form.customer.address = payload.address;
    },
    INSERT_FORM_CUSTOMER_CITY(state, payload) {
      state.form.customer.city_id = payload.city_id;
    },
    INSERT_FORM_CUSTOMER_NO_TELP(state, payload) {
      state.form.customer.no_telp = payload.no_telp;
    },
    INSERT_FORM_CUSTOMER_NATIONAL_ID_CARD(state, payload) {
      state.form.customer.national_id_card = payload.national_id_card;
    },
    INSERT_FORM_CUSTOMER_DRIVER_LICENSE(state, payload) {
      state.form.customer.driver_license = payload.driver_license;
    },
    INSERT_FORM_CUSTOMER_FAMILY_CARD(state, payload) {
      state.form.customer.family_card = payload.family_card;
    },
